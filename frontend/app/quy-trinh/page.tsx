...
const steps = [
  ...
  },
  {
    ...
    desc: "Đo đạc và lắng nghe thói quen sinh hoạt thật của gia đình bạn — không áp thiết kế dựng sẵn.",
  },
  {
    ...
    desc: "Cùng xem và hiểu rõ từng lựa chọn trước khi nhận báo giá — ký vì tin, không phải vì tiếc công.",
  },
  {
